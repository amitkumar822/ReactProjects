      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className=" md:text-2xl text-lg font-bold cursor-pointer">Book <span className=" text-pink-500">Store</span></a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className=" hidden md:block">
              <label className="px-2 py-1 border rounded-md flex items-center gap-2 ">
                <input
                  type="text"
                  className={`grow outline-none bg-white dark:bg-slate-900 px-1 py-1 ${sticky?"dark:bg-[#3a424e] ":""}`}
                  placeholder="Search"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="">
              <a className=" bg-blue-600 text-white px-3 py-2 rounded-md hover:bg-blue-500 duration-300 cursor-pointer"
